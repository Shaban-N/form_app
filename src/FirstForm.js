...
export default class FirstForm extends React.Component {
    ...
    nextForm = () => {
        const isValidEmail = this.props.email.search(/[\w\.]*@\w*\.[a-z]{2,3}/) != (-1);
        this.setState({isEmailValid: isValidEmail});
        isValidEmail && this.props.name && this.props.nextForm()
    };
    ...
    render() {
        ...
        return (
            <div className="center_wrapper">
                ...
                <p className='form__name'>1.Введите имя и e-mail</p>
